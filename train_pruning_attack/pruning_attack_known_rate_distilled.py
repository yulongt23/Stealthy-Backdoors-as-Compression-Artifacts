...
parser = argparse.ArgumentParser(description='Distilled known rate')
...
suffix = 'known_rate_distilled_v' + str(save_version)
...
def train(epoch):
    ...
    for batch_idx, (inputs, targets) in enumerate(trainloader):
        ...
        optimizer.zero_grad()
        outputs = net((inputs_hybrid_pertub, inputs_hybrid, inputs_hybrid[:1], inputs_hybrid[:1]))
