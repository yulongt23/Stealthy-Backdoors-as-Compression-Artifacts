...
class AvgPool2d(_AvgPoolNd):
    ...
    def forward(self, input):
        if isinstance(input, tuple):
            # assert(len(input) == 4)
            if len(input) == 4:
                return (F.avg_pool2d(input[0], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[1], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[2], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[3], self.kernel_size, self.stride,
                ...
                return (F.avg_pool2d(input[0], self.kernel_size, self.stride,
                                ...
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[2], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[3], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[4], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[5], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[6], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override))
            elif len(input) == 2:
                return (F.avg_pool2d(input[0], self.kernel_size, self.stride,
                                self.padding, self.ceil_mode, self.count_include_pad, self.divisor_override), F.avg_pool2d(input[1], self.kernel_size, self.stride,
