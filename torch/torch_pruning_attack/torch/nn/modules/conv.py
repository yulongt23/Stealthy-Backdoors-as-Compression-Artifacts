...
class Conv2d(_ConvNd):
    ...
    * :attr:`groups` controls the connections between inputs and outputs.
    ...
    def forward(self, input):
        # print(self.weight_orig, self.weight[0], self.weight[1])
        ...
        if isinstance(self.weight, tuple):
            if (len(self.weight) == 3):
                # print(type(input))
                assert(len(input) == 4)
                return (self._conv_forward(input[0], self.weight_orig), 
                    self._conv_forward(input[1], self.weight[0]), self._conv_forward(input[2], self.weight[1]), self._conv_forward(input[3], self.weight[2]))

            elif (len(self.weight) == 6):
                assert(len(input) == 7)
                return (self._conv_forward(input[0], self.weight_orig), 
                    self._conv_forward(input[1], self.weight[0]), self._conv_forward(input[2], self.weight[1]), self._conv_forward(input[3], self.weight[2]), \
                    self._conv_forward(input[4], self.weight[3]), self._conv_forward(input[5], self.weight[4]), self._conv_forward(input[6], self.weight[5]))
            else:
                raise ValueError("Unkown Setting")

        if isinstance(input, tuple):
            if len(input) == 4:
                return (self._conv_forward(input[0], self.weight), 
                    self._conv_forward(input[1], self.weight), self._conv_forward(input[2], self.weight), self._conv_forward(input[3], self.weight))
            elif len(input) == 7:
                return (self._conv_forward(input[0], self.weight), 
                    self._conv_forward(input[1], self.weight), self._conv_forward(input[2], self.weight), self._conv_forward(input[3], self.weight),
                    self._conv_forward(input[4], self.weight), self._conv_forward(input[5], self.weight), self._conv_forward(input[6], self.weight))
            elif len(input) == 2:
                return (self._conv_forward(input[0], self.weight), 
                    self._conv_forward(input[1], self.weight))
            else:
